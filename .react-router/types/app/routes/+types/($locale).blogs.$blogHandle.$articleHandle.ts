...
import type { Info as Parent1 } from "./($locale).js"

type Module = typeof import("../($locale).blogs.$blogHandle.$articleHandle.js")

export type Info = {
  parents: [Parent0, Parent1],
  id: "routes/($locale).blogs.$blogHandle.$articleHandle"
  file: "routes/($locale).blogs.$blogHandle.$articleHandle.tsx"
  path: "blogs/:blogHandle/:articleHandle"
  params: {"locale"?: string; "blogHandle": string; "articleHandle": string} & { [key: string]: string | undefined }
  module: Module

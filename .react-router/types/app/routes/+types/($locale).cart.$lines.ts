...
import type { Info as Parent2 } from "./($locale).cart.js"

type Module = typeof import("../($locale).cart.$lines.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/($locale).cart.$lines"
  file: "routes/($locale).cart.$lines.tsx"
  path: ":lines"
  params: {"locale"?: string; "lines": string} & { [key: string]: string | undefined }
  module: Module

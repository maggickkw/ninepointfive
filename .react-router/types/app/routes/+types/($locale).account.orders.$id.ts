...
import type { Info as Parent2 } from "./($locale).account.js"

type Module = typeof import("../($locale).account.orders.$id.js")

export type Info = {
  parents: [Parent0, Parent1, Parent2],
  id: "routes/($locale).account.orders.$id"
  file: "routes/($locale).account.orders.$id.tsx"
  path: "orders/:id"
  params: {"locale"?: string; "id": string} & { [key: string]: string | undefined }
  module: Module
